          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(AppLocalizations.of(context)!.termsAndConditions,style: GoogleFonts.aBeeZee(
                      fontSize: 35.0,
                      letterSpacing: 1.0,
                    ...
                    SizedBox(height: 10,),
                  Text(
                    AppLocalizations.of(context)!.termsAndConditionsText1,
                  ...
                  Text(AppLocalizations.of(context)!.termsAndConditionsText2, style: GoogleFonts.aBeeZee(
                      fontSize: 25.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w900,
                      color: kPrimaryColor,
                    ),),
                    Text(AppLocalizations.of(context)!.termsAndConditionsText3, style: GoogleFonts.aBeeZee(
                      fontSize: 20.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w500,
                      color: kPrimaryColor,
                    ...
                    SizedBox(height: 10,),
                    Text(AppLocalizations.of(context)!.termsAndConditionsText4, style: GoogleFonts.aBeeZee(
                      fontSize: 25.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w900,
                      color: kPrimaryColor,
                    ),),
                    Text(AppLocalizations.of(context)!.termsAndConditionsText5, style: GoogleFonts.aBeeZee(
                      fontSize: 20.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w500,
                      color: kPrimaryColor,
                    ...
                    SizedBox(height: 10,),
                    Text(AppLocalizations.of(context)!.termsAndConditionsText6, style: GoogleFonts.aBeeZee(
                      fontSize: 25.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w900,
                      color: kPrimaryColor,
                    ),),
                    Text(AppLocalizations.of(context)!.termsAndConditionsText7, style: GoogleFonts.aBeeZee(
                      fontSize: 20.0,
                      letterSpacing: 1.0,
                      fontWeight: FontWeight.w500,
                      color: kPrimaryColor,
